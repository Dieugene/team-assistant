...
- См. `00_docs/standards/common/testing-strategy.md`
...
1. Прочитай `overview.md` от Architect
2. **Проверь доступ к проектам-источникам** (указаны в overview.md)
3. Нет доступа → запроси у пользователя
4. Изучи существующие паттерны в проектах-источниках

**См. также:**
- `00_docs/standards/tech-lead/decomposition.md` — декомпозиция задач
- `00_docs/standards/common/testing-strategy.md` — моки vs реальные данные
